...
public:
  ...
  void addReadCounts(const std::vector<std::pair<std::tuple<ChromosomeLabel, unsigned int, char, std::vector<char>>,std::vector<CellReadCounts>>> &);
  void addReadCounts(std::vector<std::pair<std::tuple<ChromosomeLabel, unsigned int, char, std::vector<char>>,std::vector<CellReadCounts>>> &&);
