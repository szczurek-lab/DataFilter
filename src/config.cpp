...
int parseCommandLineArgs(
  ...
  required.add_options()
          (
                  "cellNames",
                  boost::program_options::value<decltype(config.cellNamesFileName)>(
                          &config.cellNamesFileName)->required(),
  ...
  optional.add_options()
          ...
          (
                  "me",
                  boost::program_options::value<decltype(config.excludedMutatedSitesFileName)>(
                          &config.excludedMutatedSitesFileName),
          ...
          (
                  "mi",
                  boost::program_options::value<decltype(config.includedMutatedSitesFileName)>(
                          &config.includedMutatedSitesFileName),
          ...
          (
                  "mnc",
                  boost::program_options::value<decltype(config.maxNormalCellsToMutate)>(
                          &config.maxNormalCellsToMutate),
  ...
  try {
    boost::program_options::store(boost::program_options::command_line_parser(argc, argv).options(allOptions).run(),
                                  vm);
